...
import { assertUsage } from '~/@honcho/utils/assert'
...
export async function buildMergedResources(root: string) {
  console.log('buildMergedResources')
  ...
  writeMergedFile(file, resourceFileMap)
...
function writeMergedFile(file: SourceFile, resourceFileMap: AllResourceFileMap) {
